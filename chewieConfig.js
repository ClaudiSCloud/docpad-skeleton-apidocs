const config = {
  ...
  docuUrl: process.env.docuURL || 'https://ClaudiSCloud.github.io',
  ...
  registry: {
    ...
    path: process.env.REGISTRY_PATH || 'https://github.com/ClaudiSCloud/apidoc-workshop-docu_registry.git',
